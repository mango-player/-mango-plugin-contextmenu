(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["mangoPluginContextmenu"] = factory();
	else
		root["mangoPluginContextmenu"] = factory();
...
var _mangoPluginPopup = __webpack_require__(3);

var _mangoPluginPopup2 = _interopRequireDefault(_mangoPluginPopup);

var _mangoHelper = __webpack_require__(4);
...
var switchToFlashEvt = 'switchToFlash';
/* 右键菜单插件
 * 接收参数：baseMenus, menus
 * 也可通过方法 updatemenu 更新自定义菜单项
 */
var contextmenuConf = (0, _mangoPluginPopup2.default)({
    tagName: 'chimee-menu',
    ...
    data: {
        ...
        baseMenus: [{
            ...
            text: '使用FLASH播放器',
            action: switchToFlashEvt
        }]
    },
    create: function create() {
        var _this = this;
        var _a = this.$config,
            baseMenus = _a.baseMenus,
            menus = _a.menus;
        if ((0, _mangoHelper.isArray)(baseMenus)) {
    ...
    events: {
        contextmenu: function contextmenu(e) {
            ...
            if ((0, _mangoHelper.isFunction)(containerEl.getBoundingClientRect)) {
    ...
    methods: {
        ...
        updatemenu: function updatemenu(menusConfig) {
            var _this = this;
            var menus = [];
            if ((0, _mangoHelper.isArray)(menusConfig)) {
                menus = menus.concat(menusConfig);
            }
            // 菜单模板编译
            var meunsHTML = menus.concat(this.baseMenus).map(function (_a) {
                var hide = _a.hide,
                    disable = _a.disable,
                    action = _a.action,
        ...
        clickHandler: function clickHandler(e) {
            ...
            if (!el.disable) {
                ...
                if (act) {
                    // 抛出右键项点击对应事件给全局
                    this.$emit(act);
                    (0, _mangoHelper.isFunction)(this[act]) && this[act](e);
                }
                this.close();
            }
            e.stopPropagation();
...
exports.default = contextmenuConf;
